...
//     map.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if(location!=null){
            ...
            gMap.addMarker(new MarkerOptions().position(myPosition).title("나의 위치"));
        }
    }
    ...
    GoogleMap.OnMarkerClickListener listener = new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            if (marker.equals(seoul))
                Toast.makeText(MainActivity3.this, "여기는 서울입니다", Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(MainActivity3.this, "여기는 인천입니다", Toast.LENGTH_SHORT).show();
            return false;
        }
    };
